...
int create_pointer(va_list val);
...
int printing_precision1(va_list val);
int function_output(va_list val);
int betty_output(va_list args);
int character_flag(va_list val);
int string_rev(va_list args);
int rot13(va_list args);
int write_exclusive(va_list args);
int printf _dec(va_list args);
int _strlen(char *s);
